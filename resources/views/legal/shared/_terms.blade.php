{{-- From https://termsandconditionstemplate.com/generate/ --}}
...
<p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use {{ config('app.name') }}'s website if you do not accept all of the terms and conditions stated on this page.</p>
...
<p>We employ the use of cookies. By using {{ config('app.name') }}'s website you consent to the use of cookies
    in accordance with {{ config('app.name') }}’s privacy policy.</p>
...
<p>You must not:</p>
<ol>
    <li>Republish material from https://honeyshousehold.com</li>
    <li>Sell, rent or sub-license material from https://honeyshousehold.com</li>
    <li>Reproduce, duplicate or copy material from https://honeyshousehold.com</li>
</ol>
...
<p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
    you must notify us by sending an e-mail {{-- to <a href="mailto:support@honeyshousehold.com" title="send an email to support@honeyshousehold.com">support@honeyshousehold.com</a> --}}.
