                ...
                <div class="tab-pane show active" id="details" role="tabpanel" aria-labelledby="detailsTab">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="birthdate" id="birthdate" class="form-control dateField datepicker" placeholder="{{ __('family-members.birthdate') }}" value="{{ old('birthdate', Auth::user()->formatDate($member->birthdate)) }}">
