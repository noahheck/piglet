...
@section('title')
    - {{ $family->name }} - {{ __('cash-flow-plans.cash-flow-plans') }} - {{ __('months.' . $cashFlowPlan->month) . ' ' . $cashFlowPlan->year }} - {{ __('piggy-banks.piggy-banks') }} - {{ ucwords(__('form.add_new')) }} {{ __('piggy-banks.contribution') }}
@endsection
...
@section('content')
    ...
    @include('family.shared.breadcrumb', [
        ...
        'location'   => ucwords(__('form.add_new')) . ' ' .__('piggy-banks.contribution'),
        /*'menu' => [
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-12 col-md-10 col-lg-8 col-xl-7">
            ...
            @include('family.cash-flow-plans.piggy-bank-contributions._form', [
                'action'      => route('family.cash-flow-plans.piggy-bank-contributions.store', [$family, $cashFlowPlan, 'return' => App\urlWithQueryString(url()->previous(), ['scroll' => 1])]),
                'method'      => false,
