...
@section('title')
    - {{ $family->name }} - {{ __('cash-flow-plans.cash-flow-plans') }} - {{ __('months.' . $cashFlowPlan->month) . ' ' . $cashFlowPlan->year }} - {{ __('piggy-banks.piggy-bank-contributions') }} - {{ $contribution->title() }} - {{ __('form.edit') }}
@endsection
