            ...
            @else
                ...
                <table class="table table-sm">
                    ...
                    @foreach ($recurringExpenses->where('category_id', null) as $recurringExpense)
                        ...
                        <tr class="{{ ($recurringExpense->hasMissingProjectedValue()) ? 'bg-subtle-warning' : '' }}" id="recurringExpense_{{ $recurringExpense->id }}" data-recurring-expense-id="{{ $recurringExpense->id }}">
